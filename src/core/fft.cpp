...
void Fft2048::transform_real(const float* time_in, float* real_out, float* imag_out) {
    if (!initialized_) init();
...
void Fft256::transform_real(const float* time_in, float* real_out, float* imag_out) {
    if (!initialized_) init();
